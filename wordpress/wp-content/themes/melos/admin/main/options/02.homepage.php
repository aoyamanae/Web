...
$thinkup_homepage_sliderimage4_link  = thinkup_var ( 'thinkup_homepage_sliderimage4_link' );
	...
	if( ! empty( $thinkup_homepage_sliderimage4_link ) ) {
...
$slider_default = NULL;
	...
	if ( is_front_page() ) {
		...
		$slider_default .= '<li><img src="' . esc_url( get_template_directory_uri() ) . '/images/transparent.png" style="background: url(' . esc_url( get_template_directory_uri() ) . '/images/slideshow/slide_demo4.png) no-repeat center; background-size: cover;" alt="' . esc_attr__( 'Demo Image', 'melos' ) . '" /></li>';
		...
		if ( ( current_user_can( 'edit_theme_options' ) and empty( $thinkup_homepage_sliderswitch ) ) or $thinkup_homepage_sliderswitch == 'option1' ) {
			...
			if( empty( $thinkup_homepage_sliderimage1_image ) and empty( $thinkup_homepage_sliderimage2_image ) and empty( $thinkup_homepage_sliderimage3_image ) and empty( $thinkup_homepage_sliderimage4_image ) ) {
...
$thinkup_homepage_section4_button    = thinkup_var ( 'thinkup_homepage_section4_button' );
	...
	$imagesize1 = 'column4-2/5'; //column3-2/5
	...
	if ( empty( $thinkup_homepage_section4_title ) ) $thinkup_homepage_section4_title = __( 'Step 4 &#45; Create Homepage', 'melos' );
	...
	$thinkup_homepage_section4_desc = __( 'To add featured content go to Theme Options &#45;&#62; Homepage (Featured) and turn the switch on then add the content you want for each section.', 'melos' );
	...
	if ( empty( $thinkup_homepage_section3_button ) )
		...
		$thinkup_homepage_section4_button = __( 'Read More', 'melos' );
	...
	if ( is_front_page() ) {
		if ( ( current_user_can( 'edit_theme_options' ) and empty( $thinkup_homepage_sectionswitch ) ) or $thinkup_homepage_sectionswitch == '1' ) {
			...
			echo '<div id="section-home">',
					'<div id="introaction-core"><div class="action-text text-center"><h3>事業内容</h3></div>',//追加
					'<div id="section-home-inner">';

			echo '<article class="section1 one_fourth">',//one_third 
