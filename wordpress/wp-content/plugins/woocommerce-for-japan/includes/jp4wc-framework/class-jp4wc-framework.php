...
namespace ArtisanWorkshop\WooCommerce\PluginFramework\v2_0_5;

if ( ! defined( 'ABSPATH' ) ) {
	exit;
}

if (!class_exists('\\ArtisanWorkshop\\WooCommerce\\PluginFramework\\v2_0_5\\JP4WC_Plugin')):
class JP4WC_Plugin {
    ...
    public function jp4wc_setting_input_checkbox($args, $description, $option_key){
        ...
        ?>
        <input type="checkbox" name="wc_sbp_options[<?php echo esc_attr($args['slug']);?>]" value="1" <?php checked( $options[ $args['slug'] ], 1 ); ?>>
